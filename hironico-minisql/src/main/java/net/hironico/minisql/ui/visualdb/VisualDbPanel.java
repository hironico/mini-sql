...
/**
 * The VisualDbPanel is the graphical modeling tool of the database.
 * For v2.1.0 this is a readonly tool. This panel uses Visual Library from NetBeans project.
 * @author hironico
 * @since 2.1.0
 */
public class VisualDbPanel extends JRoundedPanel {
     ...
     * @param dbConfig the config where the sql objects are coming from. Used to load metadata before displaying.
     */
