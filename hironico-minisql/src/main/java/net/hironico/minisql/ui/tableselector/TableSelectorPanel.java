...
import net.hironico.common.swing.BannerPanel;
...
public class TableSelectorPanel extends JPanel {
    ...
    public TableSelectorPanel() {
        ...
        bannerPanel.setSecondaryColor(TableSelectorPanel.this.getBackground());
    ...
    public void setSubTitle(String subTitle) {
        bannerPanel.setDescription(subTitle);
    }
    ...
    private void initComponents() {
        ...
        bannerPanel.setPrimaryColor(java.awt.Color.white);
        bannerPanel.setDescription("Use the list below to select the tables.");
