...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
    ...
    /*
     *	Indicates whether to include the entities data in the width calculation
     */
    ...
    /*
     *  Indicate whether changes to the entities should cause the width to be
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if ("entities".equals(e.getPropertyName())) {
